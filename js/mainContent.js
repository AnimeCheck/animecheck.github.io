        ...
        html += `
            <div class="col">
                <div class="card h-100 bg-dark text-light skeleton-card">
                    <div class="anime-thumbnail bg-secondary opacity-25"></div>
                    <div class="card-body">
...
function renderScheduleHTML(animeList) {
    ...
    for (const anime of animeList) {
        ...
        const time = anime.broadcast.time != null ? anime.broadcast.time : "N/A";
            ...
            <div class="col">
                <div class="card fade-in h-100 bg-dark text-light">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto pt-2 small card-time font-monospace text-warning">${time} (JST)</div>
